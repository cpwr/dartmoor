...
class PostgresDsnPatched(PostgresDsn):
...
class Settings(BaseSettings):
    ...
    SERVER_HOST: AnyHttpUrl = "https://example.com"
    ...
    SQLALCHEMY_DATABASE_URI: str = PostgresDsnPatched.build(
